...
function getEmailError(value) {
  ...
  if (!EMAIL_PATTERN.test(value)) {
    return "Enter a valid email address, e.g. you@organization.com.";
  }
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-white">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        >
          <path
            d="M0,160 C200,120 350,200 550,160 C750,120 900,190 1200,150 L1200,240 L0,240 Z"
            fill="#fff5ee"
          />

          <path
            d="M0,190 C220,150 380,220 600,185 C820,150 980,210 1200,175 L1200,240 L0,240 Z"
            fill="#ffe8d8"
            opacity="0.7"
          />
        </svg>
              ...
              <div className="rounded-xl border border-orange-100 bg-orange-50 px-3.5 py-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs leading-relaxed text-orange-700">
                    New accounts are registered as Analyst accounts.
                    Additional roles are assigned by the backend.
                  </p>
                </div>
              </div>
