...
class YaraScanner:
    ...
    def load_rules(self) -> yara.Rules:
        ...
        rule_files.extend(self.rules_directory.glob("*.yara"))

        if not rule_files:
            raise FileNotFoundError(
                f"No YARA rule files found in {self.rules_directory}"
            )
    ...
    def scan_file(self, file_path: str) -> dict[str, Any]:
        """Scan a file and return structured YARA detection results."""
